...
<blockquote>
	<code>
		...
		template = createObject('component', 'algid.inc.resource.structure.template').init(cgi.remote_host, navigation, theURL, i18n, 'en_US')
	</code>
</blockquote>
...
<cfset template = createObject('component', 'algid.inc.resource.structure.template').init(cgi.remote_host, navigation, theURL, i18n, 'en_US') />
